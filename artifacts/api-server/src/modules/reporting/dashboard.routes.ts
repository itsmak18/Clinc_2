...
import { getDashboardSummary, getDepartmentLoad, getRecentActivity, getFrontDeskDashboard, getNurseDashboard, getPharmacistDashboard, getBillingDashboard, getComplianceDashboard, getImagingDashboard, getLabDashboard } from "./dashboard.service";
