...
import {
  ...
  Globe, ChevronRight, Activity, UserCog
} from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { key: "patients", href: "/patients", icon: Users, labelKey: "patients" },
  { key: "appointments", href: "/appointments", icon: CalendarDays, labelKey: "appointments" },
  { key: "medical-records", href: "/medical-records", icon: FileText, labelKey: "medicalRecords", roles: ["super_admin", "admin", "doctor", "nurse"] },
  { key: "prescriptions", href: "/prescriptions", icon: Pill, labelKey: "prescriptions", roles: ["super_admin", "admin", "doctor"] },
  { key: "xray", href: "/xray", icon: Scan, labelKey: "xray" },
  { key: "lab", href: "/lab", icon: FlaskConical, labelKey: "lab" },
  { key: "billing", href: "/billing", icon: Receipt, labelKey: "billing", roles: ["super_admin", "admin", "front_desk"] },
  { key: "operations", href: "/operations", icon: Scissors, labelKey: "operations", roles: ["super_admin", "admin", "doctor"] },
  { key: "inventory", href: "/inventory", icon: Package, labelKey: "inventory", roles: ["super_admin", "admin"] },
  { key: "reports", href: "/reports", icon: BarChart3, labelKey: "reports", roles: ["super_admin", "admin", "doctor"] },
  { key: "notifications", href: "/notifications", icon: Bell, labelKey: "notifications" },
  { key: "users", href: "/users", icon: UserCog, labelKey: "users", roles: ["super_admin", "admin"] },
  { key: "audit", href: "/audit", icon: Shield, labelKey: "audit", roles: ["super_admin"] },
  { key: "settings", href: "/settings", icon: Settings, labelKey: "settings", roles: ["super_admin", "admin"] },
];
