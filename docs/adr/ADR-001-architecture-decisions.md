...
> **Superseded:** The algorithm was subsequently migrated from RS256/HS256 to **EdDSA (Ed25519)**. See `lib/jwt-secret.ts` and `secrets/README.md`. The `jose` library and `jti` tracking decisions stand; only the algorithm changed.
